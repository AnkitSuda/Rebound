...
@HiltViewModel
class MuscleSelectorBottomSheetViewModel @Inject constructor(
    handle: SavedStateHandle,
    musclesRepository: MusclesRepository,
) : ViewModel() {
    val selectedMuscleId = handle.get<String>(MUSCLE_ID_KEY)

    val muscles = musclesRepository.getMuscles()
